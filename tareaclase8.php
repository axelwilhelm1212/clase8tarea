 ...
 <body>
     <div class="container-fluid">
         <header>
            ...
            echo "<div class=\"row\">";
            echo "<div class=\"col-12 col-sm-4\"> <br> ".$registro[$i]["nombre"]."</div>";
            echo "<div class=\"col-12 col-sm-2\"> <br> ".$registro[$i]["apellido"]."</div>";
            echo "<div class=\"col-12 col-sm-2\"> <br> ".$registro[$i]["edad"]."</div>";
            echo "<div class=\"col-12 col-sm-2\"> <br> ".$registro[$i]["email"]."</div>";
            echo "<div class=\"col-12 col-sm-2\"> <br> ".$registro[$i]["dni"]."</div>";
            echo "</div>";
                }
